...
import voucherSlice, { saveUserVoucher } from '../../../redux/reducer/VoucherSlice';

const Voucher = (props) => {
    const {data,setOpenVoucher,setChoosenVoucher} = props;
    ...
    const handleChooseVoucher =()=>{
        setChoosenVoucher(data)
        console.log(data)
        dispatch(voucherSlice.actions.setUsingVoucher(data))
